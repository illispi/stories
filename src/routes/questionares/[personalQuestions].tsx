...
const getSessionAndData = cache(async () => {
  "use server";
  const sessionAndData = handleEden(
    await serverFetch(eden.api.user.personalQData.get)
  );
  return sessionAndData;
}, "sessionAndData");
        ...
        <Show
          ...
          <Show
            when={
              ...
              params.personalQuestions === "theirQuestions"
            }
            fallback={
              <div class="flex h-screen w-full flex-col items-center justify-center">
