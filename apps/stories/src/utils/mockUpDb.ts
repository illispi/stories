...
const care_after_hospital = faker.helpers.arrayElement([true, false]);
...
export const createFakeData: PersonalQuestions = {
  ...
  describe_hospital: hospitalized_on_first
    ...
    : null,
  care_after_hospital: hospitalized_on_first
    ? faker.helpers.arrayElement([true, false])
    : null,
  ...
  quitting_what_happened: quitting
    ...
    : null,
  quitting_regret: quitting ? faker.helpers.arrayElement([true, false]) : null,
  gained_weight: gained_weight,
  weight_amount: gained_weight ? faker.number.int({ min: 1, max: 300 }) : null,
  smoking: smoking,
  ...
  no_interest_socially: negative_symptoms
    ? faker.helpers.arrayElement([true, false])
    : null,
  apathy: negative_symptoms ? faker.helpers.arrayElement([true, false]) : null,
